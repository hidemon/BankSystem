...
public class Prelend extends Shell {
	private Text text;
	private Text text_2;
	private Text text_3;
	private Text text_1;
	...
	public Prelend(Display display) {
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				db.update("insert into credit_record(idcredit_card,consumption_t,date,volume,idrecord) values('"+vx0+"',2,'"+dateformatter+"',"+vx2+","+idnum+")");
