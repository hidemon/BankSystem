...
public class Intereat_Amend extends Dialog {
	 ...
	 * @param style
	 */
	public Intereat_Amend(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				db.update("update interest_rate set value="+in_value+" where name='current_deposit'");
			}
		});
		button.setBounds(82, 198, 98, 30);
		button.setText("\u786E\u5B9A");
		...
		button_1.setBounds(250, 198, 98, 30);
		button_1.setText("\u53D6\u6D88");
		
		lblNewLabel = new Label(shlInterestAmend, SWT.NONE);
		lblNewLabel.setBounds(122, 89, 103, 20);
		lblNewLabel.setText("\u4FEE\u6539\u5229\u7387\u4E3A\uFF1A");
