...
public class Intereat_Amend2 extends Dialog {
	 ...
	 * @param style
	 */
	public Intereat_Amend2(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				db.update("update interest_rate set value="+in_value+" where name='fixed_5year'");
			}
		});
