...
public class Intereat_Amend3 extends Dialog {
	 ...
	 * @param style
	 */
	public Intereat_Amend3(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				db.update("update interest_rate set value="+in_value+" where name='fixed_1year'");
			}
		});
		button.setBounds(94, 198, 98, 30);
		button.setText("\u786E\u5B9A");
