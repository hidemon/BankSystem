...
public class Manage_Loan extends ViewPart {

	public static final String ID = "view.Manage_Loan"; //$NON-NLS-1$
	private Table table;
	int page = 1;
	String str="";
	public Manage_Loan() {
	...
	public void createPartControl(Composite parent) {
		...
		btnNewButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				table.removeAll();		
				DB1 db=new DB1();				
				LinkedList<HashMap<String, String>> list = db.queryToList("select * from manager where type = 3");
				for(int i=0; i<list.size(); i++){
		...
		tblclmnid.setText("\u8D37\u6B3E\u7BA1\u7406\u5458ID");
		
		TableColumn tableColumn = new TableColumn(table, SWT.NONE);
		tableColumn.setWidth(137);
		tableColumn.setText("\u8D37\u6B3E\u7BA1\u7406\u5BC6\u7801");
		...
		button.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				Shell shl = Manage_Loan.this.getViewSite().getShell();
